...
00000000004004eb <swap>:
  ...
  4004ef:	48 c7 05 4e 0b 20 00 	movq   $0x601034,0x200b4e(%rip)        # 601048 <bufp1>
  4004f6:	34 10 60 00 
  4004fa:	48 8b 05 37 0b 20 00 	mov    0x200b37(%rip),%rax        # 601038 <bufp0>
  400501:	8b 00                	mov    (%rax),%eax
  400503:	89 45 fc             	mov    %eax,-0x4(%rbp)
  400506:	48 8b 05 2b 0b 20 00 	mov    0x200b2b(%rip),%rax        # 601038 <bufp0>
  40050d:	48 8b 15 34 0b 20 00 	mov    0x200b34(%rip),%rdx        # 601048 <bufp1>
  400514:	8b 12                	mov    (%rdx),%edx
  400516:	89 10                	mov    %edx,(%rax)
  400518:	48 8b 05 29 0b 20 00 	mov    0x200b29(%rip),%rax        # 601048 <bufp1>
